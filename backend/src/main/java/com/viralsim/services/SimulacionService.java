...
public class SimulacionService {
        ...
        private final ConfiguracionSimulacionRepository configuracionRepository;
        ...
        public SimulacionService(SimulacionRepository simulacionRepository,
                        ...
                        ConfiguracionSimulacionRepository configuracionRepository) {
        ...
        public Simulacion crearSimulacion(int grafoId, int modeloId, int nodoSemillaId) {
                ...
                Nodo nodoSemilla = nodoRepository.findById(nodoSemillaId)
                                .orElseThrow(() -> new RuntimeException(
                                                "Nodo semilla no encontrado: " + nodoSemillaId));
                ...
                // IMPORTANTE: Crear ConfiguracionSimulacion para esta simulación
                ConfiguracionSimulacion config = new ConfiguracionSimulacion();
                config.setSimulacion(simulacionGuardada);
                config.setProbabilidadGlobal(0.5);
                config.setVelocidadAnimacion(500);
